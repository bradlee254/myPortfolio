...
const contactInfo = [
  {
    icon: '✉',
    label: 'Email',
    value: 'bashir@email.com',
    link: 'mailto:bashir@email.com',
  },
  {
    icon: '◉',
    label: 'Location',
...
<template>
  ...
  >
    ...
    <div class="absolute top-1/2 right-0 w-96 h-96 border border-zinc-800/50 rounded-full translate-x-1/2 -translate-y-1/2"></div>
      ...
      <div class="grid lg:grid-cols-5 gap-12">
        ...
        <div class="lg:col-span-2 space-y-6">
          <div
            ...
            :key="info.label"
            class="group p-6 bg-zinc-900 border border-zinc-800 rounded-2xl hover:border-emerald-400/30 transition-all duration-500 transform"
            :class="isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'"
          ...
          <!-- Social Links -->
          <div 
            class="p-6 bg-zinc-900 border border-zinc-800 rounded-2xl transition-all duration-700 delay-600 transform"
            :class="isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'"
          >
            ...
            <div class="flex gap-3">
              <a
                href="#"
                class="w-10 h-10 bg-zinc-800 rounded-lg flex items-center justify-center text-zinc-400 hover:bg-emerald-400 hover:text-zinc-900 transition-all duration-300 hover:scale-110"
              >
        ...
        <!-- Contact Form -->
        <div 
          class="lg:col-span-3 transition-all duration-700 delay-700 transform"
          :class="isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'"
        >
          <form
            @submit.prevent="handleSubmit"
            class="p-8 bg-zinc-900 border border-zinc-800 rounded-2xl space-y-6"
          >
            <div>
