...
<template>
  ...
  >
    ...
    <div class="absolute top-1/4 left-0 w-96 h-96 border border-zinc-800/50 rounded-full -translate-x-1/2"></div>
    ...
    <div class="max-w-6xl mx-auto relative z-10">
      ...
      <div class="grid lg:grid-cols-2 gap-8">
        <article
          ...
          class="group relative rounded-3xl overflow-hidden bg-zinc-900 border border-zinc-800 hover:border-emerald-400/30 transition-all duration-500 transform hover:-translate-y-2"
          :class="isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'"
        ...
        >
          ...
          <div class="relative h-64 bg-zinc-950 overflow-hidden">
            ...
            <!-- <img 
              :src="`/projects/${project.title.toLowerCase().replace(/\s+/g, '-')}.jpg`" 
              :alt="project.title"
      ...
      <!-- View More CTA -->
      <div 
        class="mt-16 text-center transition-all duration-700 delay-700 transform"
        :class="isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'"
      >
        <a
